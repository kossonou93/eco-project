			...
			<div class="d-table-cell">
				<div class="container">
					<div class="page-title-content">
						<h2>Créer un Partenariat</h2>
						<ul>
							<li><a href="index.html">Accueil</a>
							</li>
							<li>Créer un Partenariat</li>
						</ul>
					</div>
				</div>
			</div>
							...
							<div class="row">
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
										<label>Entreprise ou Organisation</label>
										<input type="text" name="name" id="name" class="form-control" required placeholder="Entrez le nom de votre Entreprise ou Organisation *">
									</div>
								</div>
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
										<label>Adresse e-mail</label>
										<input type="email" name="email" id="email" class="form-control" required placeholder="Entrez votre adresse e-mail *">
									</div>
								</div>
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
										<label>Numéro de Téléphone</label>
										<input type="text" name="phone" id="phone" required class="form-control" placeholder="Entrez votre numéro de téléphone *">
									</div>
								</div>
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
										<label>Votre Logo</label>
										<input type="file" name="photo" class="form-control" placeholder="Votre Logo">
									</div>
								</div>
								<div class="col-lg-12 col-md-12">
									<div class="form-group">
										<select name="categorie_id" class="form-control input">
											<option>Choisissez le Type de Partenariat</option>
